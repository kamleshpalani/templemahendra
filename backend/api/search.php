...
$PAGES = [
    ['url' => '/about#history',       'ta' => 'கோவில் வரலாறு', 'en' => 'Temple history',
     'sub_ta' => 'பற்றி', 'sub_en' => 'About', 'kw' => 'history varalaru kumbabhishekam 1990 2012 naar petti gopuram origins clan deity kula deivam'],
    ['url' => '/about#deities',       'ta' => 'குலதெய்வங்கள்', 'en' => 'Our clan deities',
     'sub_ta' => 'பற்றி', 'sub_en' => 'About', 'kw' => 'deities lingammal renukadevi chinnammal amman goddess'],
    ['url' => '/about#trust',         'ta' => 'தர்ம அறக்கட்டளை', 'en' => 'Dharma Trust',
     'sub_ta' => 'பற்றி', 'sub_en' => 'About', 'kw' => 'trust registration 80g pan tax exemption bank ifsc account number receipt aRakkattalai'],
    ['url' => '/about#committee',     'ta' => 'திருக்கோவில் கமிட்டி', 'en' => 'Temple committee',
     'sub_ta' => 'பற்றி', 'sub_en' => 'About', 'kw' => 'committee president secretary treasurer contact members phone gengaiah kumar'],
    ['url' => '/about#timings',       'ta' => 'வழிபாட்டு நேரங்கள்', 'en' => 'Pooja timings',
     'sub_ta' => 'பற்றி', 'sub_en' => 'About', 'kw' => 'timings hours open close morning evening thiruvanandal kalasanthi uchikalam sayarakshai arthajama'],
    ['url' => '/about#land-donation', 'ta' => 'அன்னதான கூடம்', 'en' => 'Annadanam hall',
     'sub_ta' => 'பற்றி', 'sub_en' => 'About', 'kw' => 'annadanam hall land donation subbaram construction toilets rest rooms'],
    ['url' => '/donations',           'ta' => 'நன்கொடை', 'en' => 'Donate',
     'sub_ta' => 'நன்கொடை', 'sub_en' => 'Donations', 'kw' => 'donate donation nankodai bank transfer cheque 80g receipt kumbabhishekam annadanam'],
    ['url' => '/sevas',               'ta' => 'சேவை பதிவு', 'en' => 'Book a seva',
     'sub_ta' => 'சேவைகள்', 'sub_en' => 'Sevas', 'kw' => 'book booking seva pooja archana abhishekam annadanam sponsor request'],
    ['url' => '/panchangam',          'ta' => 'பஞ்சாங்க நாட்காட்டி', 'en' => 'Panchangam calendar',
     'sub_ta' => 'பஞ்சாங்கம்', 'sub_en' => 'Panchangam', 'kw' => 'panchangam calendar pournami amavasai ekadasi sashti pradosham nalla neram rahu kalam yamagandam tithi'],
    ['url' => '/contact',             'ta' => 'தொடர்பு கொள்ளுங்கள்', 'en' => 'Contact and directions',
     'sub_ta' => 'தொடர்பு', 'sub_en' => 'Contact', 'kw' => 'contact address directions map phone whatsapp email pudupatti thiruvengadam tenkasi reach visit'],
    ['url' => '/events',              'ta' => 'நிகழ்வுகள் & திருவிழாக்கள்', 'en' => 'Events and festivals',
     'sub_ta' => 'நிகழ்வுகள்', 'sub_en' => 'Events', 'kw' => 'events festivals thiruvizha pournami shivaratri karthigai calendar dates'],
];
foreach ($PAGES as $p) {
