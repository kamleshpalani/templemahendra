...
function notifyTemplateSample(string $key, string $lang): array
{
    ...
    $samples = [
        ...
        // Online payments (docs/payments/SPEC.md §6.2). paymentFor is a seva name or a
        // donation purpose on its own; payment_success adds the word "seva" itself.
        'receiptNumber'    => 'TMR-2026-000042',
        'donationAmount'   => 'Rs. 1,001',
        'donationPurpose'  => ['ta' => 'அன்னதானம்', 'en' => 'Annadanam'],
        'donationDate'     => ['ta' => '12 செப்டம்பர் 2026', 'en' => '12 Sep 2026'],
        'paymentReference' => 'DON-20260914-00001234',
        'paymentAmount'    => 'Rs. 1,001',
        'paymentFor'       => ['ta' => 'அபிஷேகம்', 'en' => 'Abhishekam'],
        'paymentDate'      => ['ta' => '14 செப்டம்பர் 2026', 'en' => '14 Sep 2026'],
        'paymentMode'      => 'UPI',
        'refundAmount'     => 'Rs. 1,001',
        'refundReference'  => 'RF12T1789300000',
